...
export class ApiI18nService {
   ...
   */
  voucherCreationType(status: VoucherCreationTypeEnum, forUserSearch = false): string {
    switch (status) {
      case VoucherCreationTypeEnum.GENERATED:
        return forUserSearch
          ? this.i18n.voucher.creationType.userGenerated
          : this.i18n.voucher.creationType.generated;
