...
export class WizardCallbackComponent extends BasePageComponent<WizardExecutionData> implements OnInit {
  constructor(injector: Injector, private wizardsService: WizardsService) {
    super(injector);
  }
