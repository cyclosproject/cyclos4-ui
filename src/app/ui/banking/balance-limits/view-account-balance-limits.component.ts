  ...
  upperCreditLimitMode(): string {
    if (this.data.upperCreditLimit) {
      return this.data.customUpperCreditLimit ?
        this.i18n.account.limits.personalized : this.i18n.account.limits.productDefault;
    } else {
      return this.data.customUpperCreditLimit ? this.i18n.account.limits.unlimited : this.i18n.account.limits.productDefault;
    }
  }
