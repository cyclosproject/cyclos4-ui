...
import { ImportedField, ImportedLineDataForSearch, ImportedLineQueryFilters, ImportedLineResult, ImportedLineStatusEnum } from 'app/api/models';
...
export class SearchImportedLinesComponent
  ...
  ngOnInit() {
    ...
    this.stateManager.cache('data', this.importsService.getImportedLinesDataForSearch({ id: this.id })).subscribe(data => this.data = data);
  }
