...
export class AnswerFormComponent extends BasePageComponent<AdQuestionView> implements OnInit {
  id: string;
  ...
  ngOnInit() {
    ...
    this.addSub(this.adQuestionService.getAdQuestion({ id: this.id }).subscribe(data => (this.data = data)));
  }
