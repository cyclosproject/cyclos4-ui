...
import { ReferenceHelperService } from 'app/users/references/reference-helper.service';
...
export class SearchReferencesComponent
  ...
  resolveMenu(data: UserReferenceDataForSearch) {
    return this.isOwner ? Menu.REFERENCES : this.authHelper.searchUsersMenu(data.user);
  }
